...
Client::Client(unsigned long ipv4, unsigned long ipv6, unsigned long port, const std::string &nickname)
...
unsigned long Client::getIpv4() const
{
  return ipv4;
}

unsigned long Client::getIpv6() const
{
  return ipv6;
}

unsigned long Client::getPort() const
{
  return port;
}
